...
func (t Training) TrainingInfo() InfoMessage {
	...
	// if t.TrainingType == "Плавание" {item.Speed = ... } - можно ли переопределить? Получается, нет.
	return item
}
...
func (r Running) Calories() float64 {
	...
	// Формула расчета:
	// (18 * средняя_скорость_в_км/ч + 1.79) *
	// вес_спортсмена_в_кг / м_в_км * время_тренировки_в_часах * мин_в_часе
...
func (r Running) TrainingInfo() InfoMessage { // ссылки нет, так как не переопределяется ничего
...
func (w Walking) Calories() float64 {
	...
	// Формула расчета:
	// (0.035 * вес_спортсмена_в_кг + (средняя_скорость_в_метрах_в_секунду**2 / рост_в_метрах) * 0.029 * вес_спортсмена_в_кг)
	// * время_тренировки_в_часах * мин_в_ч
